...
namespace School
{
    class Program
    {
        ...
        static void GetStudents()
        {
            ...
            string connectionString = "//Your connection string here";
            // a SQLConnection object is created to connect to the database, and is provided the connection string
            SqlConnection connection = new SqlConnection("Server=tcp:myfirstdatabase-abanoub.database.windows.net,1433;Initial Catalog=School;Persist Security Info=False;User ID=abanoub148;Password=G7m12a3a;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
